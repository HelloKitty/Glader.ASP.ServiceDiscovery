...
namespace Glader.ASP.ServiceDiscovery
{
	public static class IMvcBuilderExtensions
	{
		...
		/// <returns></returns>
		public static IMvcBuilder RegisterServiceDiscoveryController(this IMvcBuilder builder)
		{
		...
		private class GenericControllerFeatureProvider : IApplicationFeatureProvider<ControllerFeature>
		{
			...
			public void PopulateFeature(IEnumerable<ApplicationPart> parts, ControllerFeature feature)
			{
				...
				if(!feature.Controllers.Contains(typeof(ServiceDiscoveryController).GetTypeInfo()))
					feature.Controllers.Add(typeof(ServiceDiscoveryController).GetTypeInfo());
			}
		}
	}
}
